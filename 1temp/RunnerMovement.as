...

		{
			...
			if (absx > lim)
			{
				if (stop) //stopping
				{
					...
					f32 ice = isTileIce(map.getTile(pos+Vec2f(0, blob.getShape().getConsts().radius+3)).type) ? 5.0f : 30.0f;
					stop_force.x *= moveVars.overallScale * ice * moveVars.stoppingFactor *
